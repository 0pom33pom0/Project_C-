...
namespace Project_job
{
    public partial class Form3 : Form
    {
        ...
        private void guna2Button1_Click(object sender, EventArgs e)//หน้าหลัก
        {
            this.Hide();
            Form1 f1 = new Form1();
            f1.ShowDialog();
        }
        private void guna2Button2_Click(object sender, EventArgs e)//เริ่มเกม
        {
            this.Hide();
            Form2 f2 = new Form2();
            f2.ShowDialog();
        }
        private void guna2Button3_Click(object sender, EventArgs e)//ถัดไป
        {
            if (x < 4)
            {
                for (int i = 1; i <= 4; i++)
