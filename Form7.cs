...
namespace Project_job
{
    public partial class Form7 : Form
    {
        ...
        private void guna2Button14_Click(object sender, EventArgs e)//หน้าแรก
        {
            if (Program.tool != 0)
            {
                this.Hide();
        ...
        private void guna2Button13_Click(object sender, EventArgs e)//ออก
        {
            Application.Exit();
        }
        private void Form7_Load(object sender, EventArgs e)
        {
            if (Program.tool != 0)
            {
                guna2Button14.Text = "เล่นอีกครั้ง";
            }
            int no = 1;
