...
namespace Project_job
{
    public partial class Form5 : Form
    {
        ...
        private void Form5_Load(object sender, EventArgs e)//เก็บข้อมูลแสดงข้อมูล
        {
            string a = $"{Program.tool}.png";
            guna2PictureBox3.Image = Image.FromFile(@"D:\w2\c#\Project_job\tool\" + a);
            guna2Button5.Text = $"{Program.u}";
            player.Play();
        ...
        int l = 1;
        private void mm(object sender, EventArgs e)//ใหม่
        {
            if (l == 1)
            {
        ...
        private void dispatTick(object sender, EventArgs e)//เกมโอเวอร์ขยับ
        {
            x += 1;
        ...
        private void guna2Button2_Click(object sender, EventArgs e)//ออก
        {
            Application.Exit();
        }
        private void guna2Button1_Click(object sender, EventArgs e)//สถิติ
        {
            this.Hide();
            player.Stop();
            Form6 f6 = new Form6();
        ...
        private void guna2Button3_Click(object sender, EventArgs e)//หน้าแรก
        {
            this.Hide();
            Form1 f1 = new Form1();
            f1.ShowDialog();
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e)//หน้าแรก
        {
            this.Hide();
            Form1 f1 = new Form1();
            f1.ShowDialog();
